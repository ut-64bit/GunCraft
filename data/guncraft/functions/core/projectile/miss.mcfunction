...
# 右手
    execute if score @s GunCraft.OffSet matches 1 anchored eyes positioned ^ ^ ^ run particle smoke ^-0.2 ^ ^0.6 0 0 0 0 3 normal @s

# 真ん中
    execute if score @s GunCraft.OffSet matches 0 anchored eyes positioned ^ ^ ^ run particle smoke ^ ^ ^0.6 0 0 0 0 3 normal @s

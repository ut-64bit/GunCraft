...
# 弾薬減らす
    execute if score @s GunCraft.Reload matches 0 if predicate guncraft:have/3burst run clear @s command_block{KaguNBT:{Item:{Type:light_ammo}}} 1
    execute if score @s GunCraft.Reload matches 0 if predicate guncraft:have/bazooka run clear @s command_block{KaguNBT:{Item:{Type:explosion_ammo}}} 1
    execute if score @s GunCraft.Reload matches 0 if predicate guncraft:have/fire_gun run clear @s command_block{KaguNBT:{Item:{Type:light_ammo}}} 1
    execute if score @s GunCraft.Reload matches 0 if predicate guncraft:have/hand_gun run clear @s command_block{KaguNBT:{Item:{Type:light_ammo}}} 1
    execute if score @s GunCraft.Reload matches 0 if predicate guncraft:have/lazer_hand_gun run clear @s command_block{KaguNBT:{Item:{Type:light_ammo}}} 1
    execute if score @s GunCraft.Reload matches 0 if predicate guncraft:have/lazer_rifle run clear @s command_block{KaguNBT:{Item:{Type:heavy_ammo}}} 1
    execute if score @s GunCraft.Reload matches 0 if predicate guncraft:have/rifle run clear @s command_block{KaguNBT:{Item:{Type:heavy_ammo}}} 1
    execute if score @s GunCraft.Reload matches 0 if predicate guncraft:have/scope_rifle run clear @s command_block{KaguNBT:{Item:{Type:heavy_ammo}}} 1

    execute if score @s GunCraft.Reload matches 0 if predicate guncraft:have/3burst run scoreboard players set @s GunCraft.Reload 5

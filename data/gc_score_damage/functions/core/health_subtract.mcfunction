#> gc_score_damage:core/health_subtract
#
# MobのHealthを減算する
#
...
# 演出
    ...
    execute if data storage gc_score_damage: Argument{DisableParticle:0b} at @s run function gc_score_damage:core/damage_indicator
# リセット
